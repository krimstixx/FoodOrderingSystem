...
{
    public abstract class FoodOrderingSystemWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static FoodOrderingSystemWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(FoodOrderingSystemWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<FoodOrderingSystemDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<FoodOrderingSystemDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<FoodOrderingSystemDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<FoodOrderingSystemDbContext, Task<T>> func)
        {
            T result;
